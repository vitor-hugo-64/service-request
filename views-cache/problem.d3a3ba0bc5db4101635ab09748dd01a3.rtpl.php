<?php if(!class_exists('Rain\Tpl')){exit;}?>  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Problema
        <small>Lista de problemas cadastrados</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="/service-request/admin"><i class="fa fa-home"></i> Inicio</a></li>
        <li><a href="/service-request/admin/problem">Problema</a></li>
      </ol>
    </section>
          ...
          <div class="box box-success">
            <div class="box-header">
              <div style="margin-top: 0px;">
                <a class="btn btn-success btn-sm" href="/service-request/admin/problem/insert">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-striped" data-js="table">
                ...
                <tr>
                  <td><?php echo htmlspecialchars( $value1["problem_type_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                  <td><?php echo htmlspecialchars( $value1["description"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                  <td>
                    <a href="/service-request/admin/problem/update/<?php echo htmlspecialchars( $value1["problem_type_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                      <i class="fa fa-edit"></i>
                      Editar
                    </a>
                  </td>
                  <td>
                    <a class="text-danger" href="#" data-toggle="modal" data-target="#modal-delete-<?php echo htmlspecialchars( $value1["problem_type_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                      <i class="fa fa-trash"></i>
                      Excluir
                    </a>
                  </td>  
                  <!-- modal-content -->
                  <div class="modal fade" id="modal-delete-<?php echo htmlspecialchars( $value1["problem_type_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                      ...
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <div class="modal-body">
                            <p>Tem certeza que deseja excluir determinado Problema?</p>
                          </div>
                          <div class="modal-footer">
                            <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Cancelar</button>
                            <a href="/service-request/admin/problem/delete/<?php echo htmlspecialchars( $value1["problem_type_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" type="button" class="btn btn-danger">
                              Confirmar
                            </a>
                          </div>
                        </div>
    ...
    <script src="/service-request/res/scripts/problem.js"></script>