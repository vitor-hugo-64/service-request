              ...
              <div class="box-body table-responsive no-padding">
                <table class="table table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="/service-request/admin/direction/update/<?php echo htmlspecialchars( $value1["request_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                        <i class="fa fa-edit"></i>
                        Editar
                      </a>
                    </td>
                    <td>
                      <a class="text-danger" href="#"  data-toggle="modal" data-target="#modal-delete-<?php echo htmlspecialchars( $value1["request_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                        <i class="fa fa-ban"></i>
                        Cancelar
                      </a>
                    </td> 
                  ...
                  <div class="modal fade" id="modal-delete-<?php echo htmlspecialchars( $value1["request_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                      ...
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <div class="modal-body">
                            <p>Tem certeza que deseja excluir determinada requisição?</p>
                          </div>
                          <div class="modal-footer">
                            <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Cancelar</button>
                            <a href="/service-request/admin/direction/delete/<?php echo htmlspecialchars( $value1["request_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" type="button" class="btn btn-danger">
                              Confirmar
                            </a>
                          </div>
                        </div>
