<?php if(!class_exists('Rain\Tpl')){exit;}?>  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Direção
        <small>Lista de direções cadastradas</small>
      </h1>
      <ol class="breadcrumb">
          ...
          <div class="box box-success">
            <div class="box-header">
              ...
              <div style="margin-top: 0px;">
                <a class="btn btn-success btn-sm" href="/service-request/admin/direction/insert">
    ...
    <script src="/service-request/res/scripts/direction.js"></script>