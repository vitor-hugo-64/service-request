<?php if(!class_exists('Rain\Tpl')){exit;}?>  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="/service-request/admin/request" class="btn btn-danger btn-block margin-bottom">Descartar Edição</a>
          ...
          <div class="col-md-9">
            <div class="box box-primary">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form method="POST" action="/service-request/admin/request/update" data-js="form">
                <input type="hidden" name="user_id" value="<?php echo htmlspecialchars( $request["user_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                <input type="hidden" name="request_id" value="<?php echo htmlspecialchars( $request["request_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                <div class="box-body">
                  <div class="form-group">
                    <label for="title">Título</label>
                    <input type="text" class="form-control" name="title" id="title" value="<?php echo htmlspecialchars( $request["title"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" placeholder="Título" data-js="input">
                  </div>
                  <div class="form-group">
                    ...
                    <select class="form-control" name="problem_type_id" id="problem_type_id" data-js="input">
                      ...
                      <?php if( $value1["problem_type_id"]==$request["problem_type_id"] ){ ?>
                      <option value="<?php echo htmlspecialchars( $value1["problem_type_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" selected="selected"><?php echo htmlspecialchars( $value1["description"], ENT_COMPAT, 'UTF-8', FALSE ); ?></option>
                      <?php }else{ ?>
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="description" id="description" placeholder="Descrição" rows="5" data-js="input"><?php echo htmlspecialchars( $request["description"], ENT_COMPAT, 'UTF-8', FALSE ); ?></textarea>
                  </div>
                  <div class="form-group">
