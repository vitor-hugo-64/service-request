		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="box box-info">
					...
					<!-- /.box-header -->
					<!-- form start -->
					<form class="form-horizontal" method="post" action="/service-request/admin/sector/insert" data-js="form">
						<div class="box-body">
						...
						<div class="box-footer">
							...
							<button type="submit" class="btn btn-info pull-right">Adicionar setor</button>
						</div>
						<!-- /.box-footer -->
					</form>
				</div>
