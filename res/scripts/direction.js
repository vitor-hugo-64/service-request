( function ( w, d) {
	...
	$btn.addEventListener( 'click', function () {
		...
		if ( $search.value) {
			ajax.open( 'GET', '/service-request/admin/direction/search/' + $search.value);
		} else {
			ajax.open( 'GET', '/service-request/admin/direction/show-all');
		}
		...
		ajax.addEventListener( 'readystatechange', function () {
			...
			if ( this.readyState === 4) {
				$btn.removeChild( d.querySelector("[data-js='img-loading']"));
